...
from flask import Flask, redirect, render_template, request, url_for, flash, Response, make_response, abort, send_from_directory
...
def machines():
    ...
    return render_template("machines.html", roots=roots, machine_status=machine_status)
...
def new_checklist_template(machine_id):
    ...
    return render_template("checklist_template_form.html", machine=machine, template=None)
...
def edit_checklist_template(machine_id, template_id):
    ...
    return render_template("checklist_template_form.html", machine=machine, template=template)
...
def new_maintenance():
    ...
    return render_template("maintenance_form.html", machines=machines_with_counter, selected_machine_id=selected_machine_id, selected_machine=selected_machine)
